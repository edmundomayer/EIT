...
(function (Microsoft) {
    ...
    (function (ApplicationInsights) {
        ...
        (function (_InternalMessageId) {
            ...
            _InternalMessageId[_InternalMessageId["NONUSRACT_TelemetryDepartmentdAndNotSent"] = 32] = "NONUSRACT_TelemetryDepartmentdAndNotSent";
            ...
            _InternalMessageId[_InternalMessageId["USRACT_DepartmentRateOutOfRange"] = 50] = "USRACT_DepartmentRateOutOfRange";
                ...
                var Envelope = (function (_super) {
                    ...
                    function Envelope(data, name) {
                        ...
                        this.aiDataContract = {
                            ...
                            DepartmentRate: function () {
                                return (_this.DepartmentRate == 100) ? ApplicationInsights.FieldType.Hidden : ApplicationInsights.FieldType.Required;
                            },
...
(function (AI) {
    ...
    var ContextTagKeys = (function () {
        function ContextTagKeys() {
            ...
            this.DepartmentRate = "ai.Department.DepartmentRate";
    ...
    (function (ApplicationInsights) {
        ...
        (function (Context) {
            ...
            var Department = (function () {
                function Department(DepartmentRate) {
                    this.INT_MAX_VALUE = 2147483647;
                    if (DepartmentRate > 100 || DepartmentRate < 0) {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.USRACT_DepartmentRateOutOfRange, "Sampling rate is out of range (0..100). Sampling will be disabled, you may be sending too much data which may affect your AI service level.", { samplingRate: DepartmentRate }));
                        this.DepartmentRate = 100;
                    }
                    this.DepartmentRate = DepartmentRate;
                    this.samplingScoreGenerator = new ApplicationInsights.SamplingScoreGenerator();
                }
                Department.prototype.isDepartmentdIn = function (envelope) {
                    if (this.DepartmentRate == 100)
                        return true;
                    var score = this.samplingScoreGenerator.getSamplingScore(envelope);
                    return score < this.DepartmentRate;
                };
                return Department;
            })();
...
/// <reference path="Context/Department.ts"/>
        ...
        var TelemetryContext = (function () {
            function TelemetryContext(config) {
                ...
                if (typeof window !== 'undefined') {
                    ...
                    this.Department = new ApplicationInsights.Context.Department(config.DepartmentRate());
                }
            }
            ...
            TelemetryContext.prototype._track = function (envelope) {
                ...
                this._applyDepartmentContext(envelope, this.Department);
                ...
                if (!doNotSendItem) {
                    if (envelope.name === ApplicationInsights.Telemetry.Metric.envelopeType ||
                        this.Department.isDepartmentdIn(envelope)) {
                        var iKeyNoDashes = this._config.instrumentationKey().replace(/-/g, "");
                        envelope.name = envelope.name.replace("{0}", iKeyNoDashes);
                        this._sender.send(envelope);
                    }
                    else {
                        ApplicationInsights._InternalLogging.throwInternalUserActionable(ApplicationInsights.LoggingSeverity.WARNING, new ApplicationInsights._InternalLogMessage(ApplicationInsights._InternalMessageId.NONUSRACT_TelemetryDepartmentdAndNotSent, "Telemetry is Departmentd and not sent to the AI service.", { DepartmentRate: this.Department.DepartmentRate }));
                    }
                }
                return envelope;
            };
            ...
            TelemetryContext.prototype._applyDepartmentContext = function (envelope, DepartmentContext) {
                if (DepartmentContext) {
                    envelope.DepartmentRate = DepartmentContext.DepartmentRate;
                }
            };
        ...
        var AppInsights = (function () {
            function AppInsights(config) {
                ...
                var configGetters = {
                    ...
                    DepartmentRate: function () { return _this.config.samplingPercentage; },
            ...
            AppInsights.prototype.trackMetric = function (name, average, DepartmentCount, min, max, properties) {
                try {
                    var telemetry = new ApplicationInsights.Telemetry.Metric(name, average, DepartmentCount, min, max, properties);
